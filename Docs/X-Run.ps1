...
param (
    [Parameter(Mandatory=$true,ParameterSetName = "Emrun")]
    [switch]
    $Emrun,

    [Parameter(Mandatory=$true,ParameterSetName = "BrowserNode")]
    [switch]
    $BrowserNode,

    [Parameter(Mandatory=$true,ParameterSetName = "BrowserDeno")]
    [switch]
    $BrowserDeno,

    [Parameter(Mandatory=$true,ParameterSetName = "ConsoleNode")]
    [switch]
    $ConsoleNode,

    [Parameter(Mandatory=$true,ParameterSetName = "ConsoleDeno")]
    [switch]
    $ConsoleDeno,
