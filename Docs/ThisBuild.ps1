...
<!-- _BEGIN_MODULE_SCRIPT_ -->
    ...
    <script type="module">
        import { default as $fxExportName } from "./Build/Module/$ModuleFileName"
...
<!-- _BEGIN_MODULE_SCRIPT_ -->
    <!-- The provided code is autogenerated. Do not modify. -->
    <script src="Build/Module/$ModuleFileName"></script>
    <script>
...
//The provided code is autogenerated. Do not modify.
import {default as factory} from "./Build/Module/$ModuleFileName"
...
"@
    ...
    $COMPILED_MODULE_FILE = "$COMPILED_MODULE_DIR/$ModuleFileName"
    ...
    & "$env:EMSCRIPTEN_COMPILER" `
        ...
        "$(Get-InsaneDir -Lib -ReleaseMode)/$INSANE_LIB_NAME" `
        -I $PSScriptRoot/Include `
        -I  "$(Get-InsaneDir -Include -ReleaseMode)" `
        -o "$COMPILED_MODULE_FILE" `
